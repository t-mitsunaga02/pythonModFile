...
def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    blob_list = blob_service_client.get_blob_client(container=container_name, blob=blob_name_in)

    # 各Blobに対する処理
    if blob_list.name.endswith('.xlsx'):
        blob_client = blob_service_client.get_blob_client(container_name, blob_list.name)
